export default function NewVehicleLoading() {
  return (
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-8 animate-pulse">
      ...
      <div className="h-9 w-48 bg-fleet-border rounded-lg mb-6" />
      {[...Array(4)].map((_, i) => (
        <div key={i} className="bg-fleet-card border border-fleet-border rounded-xl p-5 shadow-card mb-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {i === 3 && <div className="col-span-2"><div className="h-12 border-2 border-dashed border-fleet-border rounded-xl" /></div>}
          </div>
        </div>
      ))}
